...
> **Note:** Alternatively, you can use `npx tsp-client` without a global install, or use the in-repo tool via `npm --prefix eng/common/tsp-client exec --no -- tsp-client`.
