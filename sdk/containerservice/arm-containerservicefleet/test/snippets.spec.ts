...
import { ContainerServiceFleetClient } from "../src/index.js";
...
describe("snippets", () => {
  ...
  it("ReadmeSampleCreateClient_Browser", async () => {
    ...
    const subscriptionId = "00000000-0000-0000-0000-000000000000";    const client = new ContainerServiceFleetClient(credential, subscriptionId);
  });
